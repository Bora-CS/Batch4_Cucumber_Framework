...
public class AddExperienceStepDefinitions {
	...
	public void user_send_a_request_to_add_experience_with_data(String title, String company, String location, String from, String to, String currentString, String description) {
